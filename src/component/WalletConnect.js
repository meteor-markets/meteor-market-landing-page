    ...
    <div>
      ...
      >
        <DialogContent>
          ...
          <Typography variant='body1' align='center' style={{ marginTop: '10px', marginBottom: '20px' }}>
          ...
          {SUPPORTED_WALLETS.map((item, i) => {
            return (
              <Button
                fullWidth
                variant='contained'
                disabled={item.data.name == 'Phantom Wallet' || item.data.name == 'Coinbase Wallet'}
                className={classes.walletBtns}
                onClick={() => {
